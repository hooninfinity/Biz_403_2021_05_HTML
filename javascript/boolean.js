...
// if(값) 명령을 사용할때
//  값에 위에 나열한 type 데이터가 나타나면 논리적으로 false 인식되고
//  그 외에는 무조건 true
...
동등연산자( == )
    자동으로 형변환이 발생한다.
    0 == '0' 을 비교하면 문자열 '0'을 숫자 0으로 자동형변환을 해 버린다.
...
// parseInt()는 문자열형 숫자를 실제 숫자로 변환하는 JS 함수
